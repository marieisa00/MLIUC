    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="code1.php" class="active"><span class="las la-user-circle" ></span>
...
if($result){
    ...
    $nomDemande=$row['nomDemande'];
    $prenomDemande=$row['prenomDemande'];
    $justificatif=$row['justificatif'];
    $classeDemande=$row['classeDemande'];
    echo '<tr>
    <th scope="row">'.$idDemande.'</th>
    <td>'.$nomDemande.'</td>
    <td>'.$prenomDemande.'</td>
    <td>'.$justificatif.'</td>
    <td>'.$classeDemande.'</td>
    <td>
        <button class="btn btn-danger"><a href="deletedemande.php?deleteid='.$idDemande.'" class="text-light">Supprimer</a></button>
    </td>
  </tr>';
    }
}
